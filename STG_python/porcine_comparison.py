# -*- coding: utf-8 -*-
"""
Porcine Hydrogel Comparison Script
Compares: Porcine 20% + 10% Glass Beads vs Porcine 20% + 0% Glass Beads
...
composition1 = {'gel': 'porcine', 'gel_wt': 20, 'particle': 'gb', 'particle_wt': '10'}
composition2 = {'gel': 'porcine', 'gel_wt': 20, 'particle': 'gb', 'particle_wt': '0'}
...
print(f"Found {len(comp1_data)} trials for Porcine 20% + 10% GB")
print(f"Found {len(comp2_data)} trials for Porcine 20% + 0% GB")

# Create comparison plots
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(16, 6))

# Colors and markers for each composition
colors = ['#1f77b4', '#d62728']  # Blue for composite (10% GB), Red for non-composite (0% GB)
markers = ['o', 's']  # Circle, Square
labels = ['Porcine 20% + 10% GB', 'Porcine 20% + 0% GB']
...
ax1.set_title('Porcine Hydrogel Comparison: Max Stress vs Strain\n(20% Porcine + 10% GB vs 20% Porcine + 0% GB)', 
...
ax2.set_title('Porcine Hydrogel Comparison: Energy Absorption vs Strain\n(20% Porcine + 10% GB vs 20% Porcine + 0% GB)', 
              fontsize=16, fontweight='bold')
...
# Save plots
output_filename = 'porcine_comparison_max_stress_and_energy_vs_strain'
...
print("\nSummary:")
print(f"- Porcine 20% + 10% GB: {len(comp1_data)} trials")
print(f"- Porcine 20% + 0% GB: {len(comp2_data)} trials")
